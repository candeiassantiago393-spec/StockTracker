...
echo  6 - Popup editar componente  popups\gui_popup_edit.ui
echo  7 - Popup confirmacao         popups\gui_popup_confirm.ui
echo.
set /p OPCAO=Opcao [1-7, Enter=1]: 
...
if "%OPCAO%"=="6" goto edit
if "%OPCAO%"=="7" goto confirm
echo Opcao invalida.
pause
exit /b 1
