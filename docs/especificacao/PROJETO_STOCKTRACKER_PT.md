...
- Interface gráfica PySide6 com os templates Siemens — páginas **Components**, **Passive (R/C)**, **Equipments** e **Statistics**;
...
Word: `word/StockTracker_Documentacao_Projeto.docx` (regenerar com `python tools/build_project_docx.py`).

Manual de utilização: [MANUAL_UTILIZADOR.md](../guias/MANUAL_UTILIZADOR.md)

Organização física do armário (Stock 1/2/3, boxes): [ARMARIO_LABORATORIO.md](../guias/ARMARIO_LABORATORIO.md) — detalhe no backup Excel mais recente em `data/backups/`.
...
- Melhorias futuras: `docs/roadmap/MELHORIAS_PENSADAS.md`.
