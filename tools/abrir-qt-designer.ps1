# Open Qt Designer — Components or Equipments (.ui in src/gui/designer).
...
$files = @{
    ...
    "2" = @{ Name = "Equipments (gui_equipments.ui)";   Path = Join-Path $DesignerDir "gui_equipments.ui" }
}

Write-Host ""
Write-Host "Stock Tracker — Qt Designer (repo)"
Write-Host "  1 - Components   gui_stocktracker.ui"
Write-Host "  2 - Equipments   gui_equipments.ui"
Write-Host ""
