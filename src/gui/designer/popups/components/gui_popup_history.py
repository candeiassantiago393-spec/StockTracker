...
class Ui_PopupHistory(object):
    def setupUi(self, PopupHistory):
        if not PopupHistory.objectName():
            PopupHistory.setObjectName(u"PopupHistory")
        PopupHistory.resize(850, 480)
        PopupHistory.setStyleSheet(u"*{\n"
"	border:none;\n"
"	background: #000028;\n"
"	padding: 0;\n"
"	margin: 0;\n"
...
"}\n"
"")
        self.gridLayout = QGridLayout(PopupHistory)
        self.gridLayout.setObjectName(u"gridLayout")
        self.container_main_body = QWidget(PopupHistory)
...
"}")
        ...
        self.retranslateUi(PopupHistory)

        QMetaObject.connectSlotsByName(PopupHistory)
    # setupUi
    ...
    def retranslateUi(self, PopupHistory):
        ...
        ___qtablewidgetitem1.setText(QCoreApplication.translate("PopupHistory", u"User", None))
        ___qtablewidgetitem2 = self.table_history.horizontalHeaderItem(2)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("PopupHistory", u"Supplier Reference", None))
        ___qtablewidgetitem3 = self.table_history.horizontalHeaderItem(3)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("PopupHistory", u"Movement", None))
        ___qtablewidgetitem4 = self.table_history.horizontalHeaderItem(4)
        ___qtablewidgetitem4.setText(QCoreApplication.translate("PopupHistory", u"Quantity", None))
        ___qtablewidgetitem5 = self.table_history.horizontalHeaderItem(5)
        ___qtablewidgetitem5.setText(QCoreApplication.translate("PopupHistory", u"Stock After", None))
        self.btn_ok.setText(QCoreApplication.translate("PopupHistory", u"Close", None))
        self.btn_cancel.setText(QCoreApplication.translate("PopupHistory", u"Cancel", None))
    # retranslateUi
