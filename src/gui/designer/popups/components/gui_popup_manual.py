...
################################################################################
## Form generated from reading UI file 'gui_popup_manual.ui'
##
...
class Ui_PopupManual(object):
    def setupUi(self, PopupManual):
        if not PopupManual.objectName():
            PopupManual.setObjectName(u"PopupManual")
        PopupManual.resize(641, 520)
        PopupManual.setStyleSheet(u"*{\n"
"	border:none;\n"
"	background: #000028;\n"
"	padding: 0;\n"
"	margin: 0;\n"
...
"}\n"
"")
        self.gridLayout = QGridLayout(PopupManual)
        self.gridLayout.setObjectName(u"gridLayout")
        self.container_main_body = QWidget(PopupManual)
...
"border: 1px solid #009999;")
        ...
        self.form_manual = QFormLayout(self.body_form)
        self.form_manual.setSpacing(6)
        self.form_manual.setObjectName(u"form_manual")
        ...
        self.form_manual.setWidget(0, QFormLayout.ItemRole.LabelRole, self.label_Supplier_Reference)
...
"")
        ...
        self.form_manual.setWidget(0, QFormLayout.ItemRole.FieldRole, self.supplier_reference)

        self.label_Manufacturer = QLabel(self.body_form)
        self.label_Manufacturer.setObjectName(u"label_Manufacturer")

        self.form_manual.setWidget(1, QFormLayout.ItemRole.LabelRole, self.label_Manufacturer)
...
"")
        ...
        self.form_manual.setWidget(1, QFormLayout.ItemRole.FieldRole, self.manufacturer)
        ...
        self.form_manual.setWidget(2, QFormLayout.ItemRole.LabelRole, self.label_Manufacturer_Reference)
...
"")
        ...
        self.form_manual.setWidget(2, QFormLayout.ItemRole.FieldRole, self.manufacturer_reference)

        self.label_Description = QLabel(self.body_form)
        self.label_Description.setObjectName(u"label_Description")

        self.form_manual.setWidget(3, QFormLayout.ItemRole.LabelRole, self.label_Description)
...
"")
        ...
        self.form_manual.setWidget(3, QFormLayout.ItemRole.FieldRole, self.description_field)

        self.label_Initial_Stock = QLabel(self.body_form)
        self.label_Initial_Stock.setObjectName(u"label_Initial_Stock")

        self.form_manual.setWidget(4, QFormLayout.ItemRole.LabelRole, self.label_Initial_Stock)

        self.initial_stock = QSpinBox(self.body_form)
        self.initial_stock.setObjectName(u"initial_stock")
        self.initial_stock.setMinimum(0)
        self.initial_stock.setMaximum(999999)
        self.initial_stock.setStyleSheet(u"\n"
"QLineEdit {\n"
"    min-width: 100px;\n"
"    max-width: 100px;\n"
"    max-height: 18px;\n"
...
"")
        ...
        self.form_manual.setWidget(4, QFormLayout.ItemRole.FieldRole, self.initial_stock)
...
"}")
        ...
        self.retranslateUi(PopupManual)

        QMetaObject.connectSlotsByName(PopupManual)
    # setupUi

    def retranslateUi(self, PopupManual):
        PopupManual.setWindowTitle(QCoreApplication.translate("PopupManual", u"Dialog", None))
        self.tittle.setText(QCoreApplication.translate("PopupManual", u"Add Manual Component", None))
        self.description.setText(QCoreApplication.translate("PopupManual", u"Supplier Reference is optional when both Manufacturer and Manufacturer Reference are provided.", None))
        self.label_Supplier_Reference.setText(QCoreApplication.translate("PopupManual", u"Supplier Reference", None))
        self.label_Manufacturer.setText(QCoreApplication.translate("PopupManual", u"Manufacturer", None))
        self.label_Manufacturer_Reference.setText(QCoreApplication.translate("PopupManual", u"Manufacturer Reference", None))
        self.label_Description.setText(QCoreApplication.translate("PopupManual", u"Description", None))
        self.label_Initial_Stock.setText(QCoreApplication.translate("PopupManual", u"Initial Stock", None))
        self.btn_ok.setText(QCoreApplication.translate("PopupManual", u"Save", None))
        self.btn_cancel.setText(QCoreApplication.translate("PopupManual", u"Cancel", None))
    # retranslateUi
