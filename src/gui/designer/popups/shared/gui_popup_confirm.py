...
################################################################################
## Form generated from reading UI file 'gui_popup_confirm.ui'
##
...
class Ui_PopupConfirm(object):
    def setupUi(self, PopupConfirm):
        if not PopupConfirm.objectName():
            PopupConfirm.setObjectName(u"PopupConfirm")
        PopupConfirm.resize(641, 320)
        PopupConfirm.setStyleSheet(u"*{\n"
"	border:none;\n"
"	background: #000028;\n"
"	padding: 0;\n"
"	margin: 0;\n"
...
"}\n"
"")
        self.gridLayout = QGridLayout(PopupConfirm)
        self.gridLayout.setObjectName(u"gridLayout")
        self.container_main_body = QWidget(PopupConfirm)
...
"}")
        ...
        self.retranslateUi(PopupConfirm)

        QMetaObject.connectSlotsByName(PopupConfirm)
    # setupUi

    def retranslateUi(self, PopupConfirm):
        PopupConfirm.setWindowTitle(QCoreApplication.translate("PopupConfirm", u"Dialog", None))
        self.tittle.setText(QCoreApplication.translate("PopupConfirm", u"Confirm", None))
        self.description.setText(QCoreApplication.translate("PopupConfirm", u"Please confirm this action.", None))
        self.btn_ok.setText(QCoreApplication.translate("PopupConfirm", u"Yes", None))
        self.btn_cancel.setText(QCoreApplication.translate("PopupConfirm", u"No", None))
    # retranslateUi
